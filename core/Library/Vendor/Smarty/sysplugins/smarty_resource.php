...
abstract class Smarty_Resource
{
    ...
    protected function buildFilepath(Smarty_Template_Source $source, Smarty_Internal_Template $_template = null)
    {
        ...
        if (!preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $file)) {
            foreach ($_directories as $_directory) {
                ...
                if ($source->smarty->use_include_path && !preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/',
                        $_directory)
                ) {
    ...
    {
        static $_incompatible_resources = array('eval'    => true,
                                                'string'  => true,
                                                'extends' => true,
                                                'php'     => true
        );
        ...
        // create source
        $source = new Smarty_Config_Source($resource, $smarty, $config_resource, $type, $name,
            $unique_resource_name);
