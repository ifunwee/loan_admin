...
class Smarty_Security
{
    ...
    public function isTrustedTag($tag_name, $compiler)
    {
        ...
        if (empty($this->allowed_tags)) {
            ...
            if (in_array($tag_name, $this->allowed_tags) && !in_array($tag_name,
                    $this->disabled_tags)
            ) {
                return true;
            } else {
    ...
    public function isTrustedModifier($modifier_name, $compiler)
    {
        ...
        if (empty($this->allowed_modifiers)) {
            if (empty($this->disabled_modifiers) || !in_array($modifier_name,
            ...
            if (in_array($modifier_name, $this->allowed_modifiers) && !in_array($modifier_name,
                    $this->disabled_modifiers)
            ) {
                return true;
            } else {
