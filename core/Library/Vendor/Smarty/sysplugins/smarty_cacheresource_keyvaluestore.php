...
abstract class Smarty_CacheResource_KeyValueStore extends Smarty_CacheResource
{
    ...
    {
        if (!$this->fetch($cached->filepath, $cached->source->name, $cached->cache_id,
            $cached->compile_id, $content, $timestamp, $cached->source->uid)
        ) {
            return;
        }
    ...
    public function process(Smarty_Internal_Template $_template, Smarty_Template_Cached $cached = null)
    {
        ...
        if ($content === null || !$timestamp) {
            if (!$this->fetch($_template->cached->filepath, $_template->source->name,
    ...
    public function writeCachedContent(Smarty_Internal_Template $_template, $content)
    {
        ...
        return $this->write(array($_template->cached->filepath => $content),
    ...
    protected function fetch($cid, $resource_name = null, $cache_id = null, $compile_id = null, &$content = null, &$timestamp = null, $resource_uid = null)
    {
        ...
        if ($content && ($timestamp = $this->getMetaTimestamp($content))) {
            $invalidated = $this->getLatestInvalidationTimestamp($cid, $resource_name, $cache_id,
                $compile_id, $resource_uid);
