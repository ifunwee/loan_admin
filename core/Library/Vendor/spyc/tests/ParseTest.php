...
class ParseTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals(array("One", array("Two", "And", "Three"), "Four", "Five"),
            $this->yaml[7]);
    }
    ...
    public function testNestedNestedInline()
    {
        $this->assertEquals(array(
            "This",
            array("Is", "Getting", array("Ridiculous", "Guys")),
            "Seriously",
            array("Show", "Mercy")
        ), $this->yaml[8]);
    }
    ...
    {
        $this->assertEquals(array("name" => "chris", "age" => "young", "brand" => "lucky strike"),
            $this->yaml[9]);
    }
    ...
    {
        $this->assertEquals(array('Perl', 'Python', 'PHP', 'Ruby'),
    ...
    {
        $this->assertEquals("Does this line in the end indeed make Spyc go to an infinite loop?",
            $this->yaml['endloop']);
    }

    public function testReallyLargeNumber()
    {
        $this->assertEquals('115792089237316195423570985008687907853269984665640564039457584007913129639936',
            $this->yaml['a_really_large_number']);
    }
    ...
    {
        $this->assertSame(array('rx' => array('tx' => array(0))),
    ...
    public function testMultilines()
    {
        $this->assertSame(array(
            array(
                'type'   => 'SomeItem',
                'values' => array('blah', 'blah', 'blah', 'blah'),
                'ints'   => array(2, 54, 12, 2143)
            )
...
dog', $this->yaml['many_lines']);
    ...
    public function testAngleQuotes()
    {
        ...
        $this->assertEquals(array(
            'html_tags'    => array('<br>', '<p>'),
            'html_content' => array('<p>hello world</p>', 'hello<br>world'),
            'text_content' => array('hello world')
        ), $Quotes);
    }
    ...
    public function testFailingColons()
    {
        ...
        $this->assertSame(array('MyObject' => array('Prop1' => array('key1:val1'))), $Failing);
    }
