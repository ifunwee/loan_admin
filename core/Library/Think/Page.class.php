...
class Page
{
    ...
    public function show()
    {
        ...
        if ($nowCoolPage == 1) {
            ...
            $prePage  = "<a href='" . str_replace('__PAGE__', $preRow,
                    $url) . "' >&lt;&lt;</a>"; //上5页改成了 <<
            $theFirst = "<a href='" . str_replace('__PAGE__', 1,
                    $url) . "' >" . $this->config['first'] . "</a>";
        }
        if ($nowCoolPage == $this->coolPages) {
            ...
            $nextPage  = "<a href='" . str_replace('__PAGE__', $nextRow,
                    $url) . "' >&gt;&gt;</a>";    // 下5页 改成了 >>
            $theEnd    = "<a href='" . str_replace('__PAGE__', $theEndRow,
                    $url) . "' >" . $this->config['last'] . "</a>";
        }
        // 1 2 3 4 5
        $linkPage = "";
