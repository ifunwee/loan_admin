(function (m, oa) {
    ...
    function Zb(a, b) {
        function e() {
            q = b.theme ? "ui" : "fc";
            if (b.header)return Q = m("<div class='fc-header' style='width:100%'/>").append(m("<div>").append(f("left")).append(f("center")).append(f("right")))
        }
    ...
    }, Aa = m.fullCalendar = {version: "1.5.2"}, Ja = Aa.views = {};
