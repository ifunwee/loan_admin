        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '				<div class="btns">';
                    html += '	    <div class="upload_boxxx"  style="float: left; text-align: center;">上传目录: <input type="text" name="dir" placeholder="为空则默认保存在根目录下"/> </div>';
                    ...
                    html += '		</div>';
                    html += '		<div id="uploadInf" class="upload_inf" style="height: 120px;overflow: auto;"></div>';
                    html += '	</div>';
                    html += '</form>';
                } else {
                    ...
                    html += '<form id="uploadForm" action="' + para.url + '" method="post" enctype="multipart/form-data">';
                    html += '	<div class="upload_box">';
                    html += '	    <div class="upload_boxxx"><input type="text" name="dir"/> </div>';
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                // 处理不同类型文件代表的图标
                var fileImgSrc = fun['ROOT'] + "/Public/Admin/img/fileType/";
            ...
            this.createCorePlug = function () {
                ...
                params = {
                    ...
                    onSuccess: function (file, response) {
                        ...
                        $("#uploadInf").append("<p>上传状态：" + response + "</p>");
                        // 根据配置参数确定隐不隐藏上传成功的文件
